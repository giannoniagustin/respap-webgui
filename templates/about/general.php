    ...
    <div class="col-md-8">
      <h2 class="mt-3"><?php echo _("RaspAP") ." v".RASPI_VERSION; ?></h2>
        ...
        <div class="mt-3">RaspAP is a co-creation of <a href="https://github.com/billz">billz</a> and <a href="https://github.com/sirlagz">SirLagz</a>
          with the contributions of our <a href="https://github.com/giannoniagustin/respap-webgui/graphs/contributors">developer community</a>
        ...
        <div class="row">
          ...
          <div class="col-md-6">License <i class="fas fa-balance-scale"></i> <a href="https://github.com/giannoniagustin/respap-webgui/blob/master/LICENSE">GPL-3.0</a></div>
        </div>
        </div>
    </div>
  </div><!-- /.row -->
